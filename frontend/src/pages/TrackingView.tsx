  ...
  return (
    <PageShell>
      <TopBar
        ...
        title="Ejecución con control continuo"
        subtitle="Estado, ownership y próximos pasos en una vista institucional de cierre premium."
        actions={
          <>
      ...
      {entry ? (
        <GlassPanel className="flow-note flow-highlight tracking-summary-note" variant="default">
